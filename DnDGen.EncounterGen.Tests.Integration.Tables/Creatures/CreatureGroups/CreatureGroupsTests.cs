...
namespace DnDGen.EncounterGen.Tests.Integration.Tables.Creatures.CreatureGroups
{
    ...
    public class CreatureGroupsTests : CreatureGroupsTableTests
    {
        ...
        [TestCase(CreatureDataConstants.Warrior_Lieutenant,
        ...
        public void AristocratBusinessmanPersonSubgroup()
        {
            ...
            base.AssertDistinctCollection(CreatureDataConstants.Aristocrat_BusinessPerson, items);
        }
        ...
        [Test]
        public void AristocratPoliticianSubgroup()
        {
            var items = new[]
            {
